...
# 1 "/home/spencer/basilisk/ghost-cell-IBM/src/test/.qcc6Ed9pS//"
# 0 "<built-in>"
# 0 "<command-line>"
...
{
  if (!(list_len(f) == vectors_len(g))) qassert ("./../ibm-gcm.h", 1382, "list_len(f) == vectors_len(g)");
  foreach_stencil(1,{0},) {
    scalar s; vector v;
...
# 1913 "./../ibm-gcm.h" 2
      ...
      static int metric(const int i,const double t,Event *_ev){tracing("metric","./../ibm-gcm.h",1914);
{
    if (is_constant (fm.x)) {
        
            if (!(constant (fm.x) == 1.)) qassert ("./../ibm-gcm.h", 1918, "constant (fm.x) == 1.");
            
#line 1918
if (!(constant (fm.y) == 1.)) qassert ("./../ibm-gcm.h", 1918, "constant (fm.x) == 1.");
        fm = ibmFaces;
    }
    foreach_face_stencil(1,{0},){_stencil_is_face_x(){ {
...
is_face_y(){ {
    ...
    if (is_constant (cm)) {
        if (!(constant (cm) == 1.)) qassert ("./../ibm-gcm.h", 1926, "constant (cm) == 1.");
        cm = ibmCells;
    }
    foreach_stencil(1,{0},) {
...
#line 1943
{
    ...
    boundary_internal ((scalar *)all, "./../ibm-gcm.h", 1951);
}{end_tracing("metric","./../ibm-gcm.h",1952);return 0;}end_tracing("metric","./../ibm-gcm.h",1952);}
# 3 "couette-plate.c" 2
# 1 "../my-centered.h" 1
# 1 "./../my-centered.h"
# 27 "./../my-centered.h"
...
{tracing("viscosity","./../my-viscosity-gcm.h",91);
...
#line 105
nrelax, res, 1
, TOLERANCE_MU ? TOLERANCE_MU : TOLERANCE);delete((scalar*)((vector[]){r,{{-1},{-1}}}));{end_tracing("viscosity","./../my-viscosity-gcm.h",106);return _ret;}}delete((scalar*)((vector[]){r,{{-1},{-1}}}));
end_tracing("viscosity","./../my-viscosity-gcm.h",107);}
# 34 "./../my-centered.h" 2
# 47 "./../my-centered.h"
scalar  p={8};
